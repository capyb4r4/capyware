...
function library:Tween(...) TweenService:Create(...):Play() end
  ...
  function library:New(name)
    ...
    TextLabel.BackgroundColor3 = COL3RGB(170, 75, 0)
    ...
    Tabs.Name = "Tabs"
    Tabs.Parent = Menu
    Tabs.BackgroundColor3 = COL3RGB(101, 67, 33)
...
repeat RunService.RenderStepped:Wait() until game:IsLoaded()
  ...
  repeat wait() until Models ~= nil
    ...
    repeat wait() until ChrModels ~= nil
      ...
      for _,lua in pairs(listfiles("capylua")) do
        local luaname = GSUB(lua, "capylua\\", "")
...
loadstring(readfile("capylua\\"..values.misc["lua scripts"].lua.Scroll))()
end)
